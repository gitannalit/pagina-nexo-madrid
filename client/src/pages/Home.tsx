 ...
 * Event: Viernes 24 y Sábado 25 de Abril 2026 — Madrid
 */
...
function CountdownTimer() {
  const eventDate = new Date('2026-04-24T09:00:00');
...
export default function Home() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      a: "El evento se celebra los días 24 y 25 de abril 2026 en Madrid. Dos días intensivos en un venue exclusivo en Madrid. Te recomendamos reservar tu plaza lo antes posible."
    },
    {
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center gap-2 text-[#C9A84C] text-sm font-semibold">
                  ...
                  <span>24 Y 25 DE ABRIL DE 2026 · MADRID</span>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-gray-400">
                ...
                <span>24-25 Abril 2026 · Madrid</span>
              </div>
            </div>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <div className="text-white text-sm font-semibold">24-25 de Abril 2026 · Madrid</div>
            </div>
            <CountdownTimer />
          ...
          <div className="max-w-3xl mx-auto space-y-3 mb-8">
            {[
              ...
              },
              {
                ...
                desc: "Preséntate el viernes 24 de abril en el venue exclusivo en Madrid. Todo está incluido.",
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[#C9A84C] text-xs font-bold tracking-widest">24-25 ABRIL 2026</div>
              </div>
            </div>
        ...
        <div className="container flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="text-white font-bold text-sm truncate">Nexo Dubái - Madrid · 24-25 Abril 2026</div>
